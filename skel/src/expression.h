...
protected:
  ...
  // operator name iff oplabel == OTHER
  string opstringlabel;
...
public:
  ...
  // set operator label
  void SetOpLabel(const string l);
...
public:
  ...
  void FBBTUpDown(map<int,double>& Vlb, map<int,double>& Vub, 
		  double elb, double eub);
  void FBBTDown(double elb, double eub);
